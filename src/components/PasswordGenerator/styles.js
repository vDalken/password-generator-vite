...
export const RangeInput = styled.input`
  ...
  &::-webkit-slider-runnable-track {
    background-color: var(--black);
    height: 6px;
    background: linear-gradient(var(--green), var(--green)) no-repeat var(--black);
    background-size: ${({$backgroundValue, $maxBackgroundValue}) => (($backgroundValue/$maxBackgroundValue)*100)-5}% 100%;
  }
